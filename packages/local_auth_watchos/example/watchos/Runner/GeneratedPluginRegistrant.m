...
extern void local_auth_watchos_is_device_supported(void);
extern void local_auth_watchos_supports_biometrics(void);
extern void local_auth_watchos_authenticate(void);
extern void local_auth_watchos_poll(void);
extern void local_auth_watchos_stop(void);
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  const void *_flutterWatchosFfiForcedReferences[] = {
    (const void *)&local_auth_watchos_is_device_supported,
    (const void *)&local_auth_watchos_supports_biometrics,
    (const void *)&local_auth_watchos_authenticate,
    (const void *)&local_auth_watchos_poll,
    (const void *)&local_auth_watchos_stop,
  };
