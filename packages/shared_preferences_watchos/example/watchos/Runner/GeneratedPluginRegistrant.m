...
extern void shared_preferences_watchos_load(void);
extern void shared_preferences_watchos_save(void);
extern void shared_preferences_watchos_free(void);
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  const void *_flutterWatchosFfiForcedReferences[] = {
    (const void *)&shared_preferences_watchos_load,
    (const void *)&shared_preferences_watchos_save,
    (const void *)&shared_preferences_watchos_free,
  };
