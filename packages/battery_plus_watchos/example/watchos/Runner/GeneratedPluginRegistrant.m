...
extern void battery_plus_watchos_level(void);
extern void battery_plus_watchos_state(void);
extern void battery_plus_watchos_is_low_power(void);
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  const void *_flutterWatchosFfiForcedReferences[] = {
    (const void *)&battery_plus_watchos_level,
    (const void *)&battery_plus_watchos_state,
    (const void *)&battery_plus_watchos_is_low_power,
  };
