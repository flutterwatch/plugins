...
| Aspect | Result |
|---|---|
| Implementation | ✅ Working (getifaddrs FFI) |
...
- [x] Declare your C functions in `watchos/Classes/network_info_plus_watchos_ffi.h` and implement them in the `.m`, one per platform-interface method you support.
