...
- [ ] Declare your C functions in `watchos/Classes/flutter_secure_storage_watchos_ffi.h` and implement them in the `.m`, one per platform-interface method you support.
