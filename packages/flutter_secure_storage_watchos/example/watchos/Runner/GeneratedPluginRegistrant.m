...
extern void flutter_secure_storage_watchos_write(void);
extern void flutter_secure_storage_watchos_read(void);
extern void flutter_secure_storage_watchos_contains(void);
extern void flutter_secure_storage_watchos_delete(void);
extern void flutter_secure_storage_watchos_read_all(void);
extern void flutter_secure_storage_watchos_delete_all(void);
extern void flutter_secure_storage_watchos_free(void);
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  const void *_flutterWatchosFfiForcedReferences[] = {
    (const void *)&flutter_secure_storage_watchos_write,
    (const void *)&flutter_secure_storage_watchos_read,
    (const void *)&flutter_secure_storage_watchos_contains,
    (const void *)&flutter_secure_storage_watchos_delete,
    (const void *)&flutter_secure_storage_watchos_read_all,
    (const void *)&flutter_secure_storage_watchos_delete_all,
    (const void *)&flutter_secure_storage_watchos_free,
  };
